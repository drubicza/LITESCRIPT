print '\x1b[31;1m\n    __    _____________________ __________  ________  ______\n   / /   /  _/_  __/ ____/ ___// ____/ __ \\/  _/ __ \\/_  __/\n  / /    / /  / / / __/  \\__ \\/ /   / /_/ // // /_/ / / /   \n \x1b[37;1m/ /____/ /  / / / /___ ___/ / /___/ _, _// // ____/ / /    \n/_____/___/ /_/ /_____//____/\\____/_/ |_/___/_/     /_/     \n'
print '\x1b[36;1m[+]\x1b[31;1m================BETA===============\x1b[36;1m[+]'
print '\x1b[32;1m   Coder By : Z3R0_5TR\n   Email    : zerostr1337@gmail.com\n   Team     : Indonesia Security Lite'
...
fdag = raw_input('\x1b[31;1m[+]\x1b[36;1m Masukkan font di atas gambar :\x1b[31;1m ')
img = raw_input('\x1b[31;1m[+]\x1b[36;1m Masukkan link gambar jpg/png :\x1b[31;1m ')
wf = raw_input('\x1b[31;1m[+]\x1b[36;1m Masukkan warna font :\x1b[31;1m ')
isi = raw_input('\x1b[31;1m[+]\x1b[36;1m Masukkan tulisan (<br> untuk enter) :\x1b[31;1m ')
thx = raw_input('\x1b[31;1m[+]\x1b[36;1m Thanks To :\x1b[31;1m ')
mulai1 = '<html>\n<head>\n<title>'
m1 = title
...
mulai03 = '<br><div class="error">\n<font color="red" size="7" face="Chicle">'
m03 = fdag
...
m7 = isi
mulai8 = '\n<marquee behavior="scroll" direction="left" scrollamount="90" scrolldelay="40" width="100%">\n<font color="green">___________________________________________________________</font></marquee>\n<div style="text-shadow: 0px 0px 10px green;"><span style="color: white;"><font face="transformers"><b>Thanks To : <marquee scrollamount="5" direction="left" width="50%"><span style="color: red;"> <span style="color: red;">'
m8 = thx
